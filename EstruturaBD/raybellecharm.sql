...
INSERT INTO `raybellecharm`.`tb_produto` (`cod_prod`, `nome_prod`, `preco`, `foto`, `descricao`, `categoria`) VALUES ('6', 'colar-ouro', '80.50', '/static/img/produtos-ouro/colar-ouro.jpg', 'Colar Raio de Sol', 'ouro');
INSERT INTO `raybellecharm`.`tb_produto` (`cod_prod`, `nome_prod`, `preco`, `foto`, `descricao`, `categoria`) VALUES ('7', 'colar-ouro2', '310.00', '/static/img/produtos-ouro/colarl-ouro2.jpg', 'Colar Vestígios do Campo', 'ouro');
INSERT INTO `raybellecharm`.`tb_produto` (`cod_prod`, `nome_prod`, `preco`, `foto`, `descricao`, `categoria`) VALUES ('8', 'conjunto-ouro', '460.00', '/static/img/produtos-ouro/conjuntol-ouro.jpg', 'Conjunto Apaixonada', 'ouro');
...
INSERT INTO `raybellecharm`.`tb_produto` (`cod_prod`, `nome_prod`, `preco`, `foto`, `descricao`, `categoria`) VALUES ('18', 'conjunto-prata2', '350.00', '/static/img/produtos-prata/conjuntol-prata2.jpg', 'Conjunto Jupter e Saturno', 'prata');
